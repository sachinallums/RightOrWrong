...
class _Play3optionsWidgetState extends State<Play3optionsWidget>
  ...
  var hasItsrightTriggered = false;
  final animationsMap = {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProblemLogsRecord>>(
      stream: queryProblemLogsRecord(
        parent: FFAppState().sessionParentReference,
        singleRecord: true,
      ),
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return InkWell(
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        hasBeenTriggered: hasItsrightTriggered);
                                  },
                                ),
                                StreamBuilder<List<GameSessionDataRecord>>(
                                  stream: queryGameSessionDataRecord(
